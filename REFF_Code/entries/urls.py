...
from entries.views import entry_list, entry_detail, entry_create, entry_update, entry_delete, EntryListView, EntryDetailView, EntryCreateView, EntryUpdateView, EntryDeleteView
