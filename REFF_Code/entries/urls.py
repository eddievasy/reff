...
from entries.views import entry_list, entry_detail, entry_create, entry_update, entry_delete, review_create, EntryListView, EntryDetailView, EntryCreateView, EntryUpdateView, EntryDeleteView, MyEntryListView, EntryListByCategoryView, MyEntryListByCategoryView, ReviewCreateView, ReviewListView, RequestEntryCreateView, EntryFillView
...
urlpatterns = [
    ...
    path('create-request/', RequestEntryCreateView.as_view(), name='entry-create-request'),
